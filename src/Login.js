...
const Login = ({ onSwitch, onLogin }) => {
  return (
    <div style={{ background: '#e6e6e6', borderRadius: '2rem', padding: '2rem', maxWidth: 350, margin: '2rem auto', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
      ...
      <button style={{ width: '100%', padding: '0.7rem', borderRadius: '0.7rem', border: '1.5px solid #a86b00', background: 'none', color: '#a86b00', fontWeight: 'bold', fontFamily: 'monospace', fontSize: '1.1rem', marginBottom: '1.5rem' }} onClick={onLogin}>Login</button>
